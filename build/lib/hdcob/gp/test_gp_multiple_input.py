...
from hdcob.gp.gaussian_process import GP_HighD
...
if __name__ == '__main__':
    ...
    # ------------------------------------------------------------------------------------------------------------------
    # ---------------------------------------- Test multiple d. gps  ---------------------------------------------------
    path_test = os.path.join(runs_path, f"test_gp_multiple_{KERNEL}_{LR}")

    # Train the model
    model = GP_HighD(init_sigma=0,
                     init_lamda=0,
                     init_noise=0,
                     init_mean=0,
                     num_inp_features=DIM_X,
                     kernel=KERNEL)
